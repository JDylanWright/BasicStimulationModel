#ifndef RTW_HEADER_UECU_Speedgoat_threshold_cal_h_
#define RTW_HEADER_UECU_Speedgoat_threshold_cal_h_
#include "rtwtypes.h"
#include "UECU_Speedgoat_threshold_types.h"

/* Storage class 'PageSwitching', for system '<Root>' */
typedef struct {
  real_T Constant1_Value[21];          /* Expression: 0:0.1:2
                                        * Referenced by: '<S6>/Constant1'
                                        */
  real_T Constant2_Value[18];          /* Expression: 2.2:0.2:5.6
                                        * Referenced by: '<S6>/Constant2'
                                        */
  real_T snp_PA_in_Value[24];          /* Expression: zeros(1,24)
  ...
  uint16_T Constant2_Value_n;          /* Computed Parameter: Constant2_Value_n
                                        ...
                                        */
  uint16_T snp_IPI_in_Value;           /* Computed Parameter: snp_IPI_in_Value
                                        * Referenced by: '<Root>/snp_IPI_in'
                                        */
  uint16_T snp_IPIMemory_InitialValue;
  ...
  uint8_T Constant3_Value[39];         /* Computed Parameter: Constant3_Value
                                        ...
                                        */
  uint8_T snp_PW_in_Value[24];         /* Computed Parameter: snp_PW_in_Value
                                        * Referenced by: '<Root>/snp_PW_in'
                                        */
  uint8_T snp_PWMemory_InitialValue[24];
  ...
  uint8_T LowPWLimMemory_InitialValue;
                               ...
                               */
  boolean_T snp_CH_in_Value[24];       /* Computed Parameter: snp_CH_in_Value
                                        * Referenced by: '<Root>/snp_CH_in'
                                        */
  boolean_T snp_CHMemory_InitialValue[24];
                                /* Computed Parameter: snp_CHMemory_InitialValue
                                 * Referenced by: '<Root>/snp_CH Memory'
                                 */
  boolean_T EnableBeep_Value;          /* Computed Parameter: EnableBeep_Value
                                        * Referenced by: '<Root>/Enable Beep'
                                        */
} UECU_Speedgoat_thresho_cal_type;

/* Storage class 'PageSwitching' */

/* Storage class 'PageSwitching' */
extern UECU_Speedgoat_thresho_cal_type UECU_Speedgoat_thresho_cal_impl;
extern UECU_Speedgoat_thresho_cal_type *UECU_Speedgoat_threshold_cal;

#endif                          /* RTW_HEADER_UECU_Speedgoat_threshold_cal_h_ */
