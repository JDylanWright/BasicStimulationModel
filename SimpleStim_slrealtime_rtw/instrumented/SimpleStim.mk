###########################################################################
## Makefile generated for component 'SimpleStim'. 
## 
## Makefile     : SimpleStim.mk
## Generated on : Thu Mar 31 18:21:01 2022
## Final product: $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim
...
PRODUCT = $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim
...
DEFINES_STANDARD = -DMODEL=SimpleStim -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/SimpleStim_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim.cpp $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim_cal.cpp $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim_data.cpp $(START_DIR)/SimpleStim_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/SimpleStim_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/SimpleStim_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim_calintf.cpp $(START_DIR)/SimpleStim_slrealtime_rtw/main.cpp $(MATLAB_ROOT)/toolbox/coder/profile/src/host_timer_x86.c $(START_DIR)/SimpleStim_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
...
OBJS = slrealtime_datatype_ground.o SimpleStim.o SimpleStim_cal.o SimpleStim_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o SimpleStim_calintf.o main.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/SimpleStim_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/SimpleStim_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/SimpleStim_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


SimpleStim.o : $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


SimpleStim_cal.o : $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


SimpleStim_data.o : $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/SimpleStim_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/SimpleStim_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/SimpleStim_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


SimpleStim_calintf.o : $(START_DIR)/SimpleStim_slrealtime_rtw/SimpleStim_calintf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/SimpleStim_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_code_profiling_utility_functions.o : $(START_DIR)/SimpleStim_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
